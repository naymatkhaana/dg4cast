...
#SBATCH --output=hyperparam_tuning_patchmtst_sepcmix_simple4.%j.out         # Standard output log
#SBATCH --error=hyperparam_tuning_patchmtst_sepcmix_simple4.%j.err          # Standard error log
